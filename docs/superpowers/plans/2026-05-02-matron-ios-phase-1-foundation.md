...
This is an iOS plan. Building, running, and testing requires **Xcode 16+ on macOS 14+**. The dev box `devbox.example.com` is Linux and CANNOT execute Xcode tasks. Two practical options for the implementing engineer:
